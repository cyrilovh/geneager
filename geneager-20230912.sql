...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 12 sep. 2023 à 21:51
...
INSERT INTO `ancestor` (`id`, `firstNameList`, `lastNameList`, `photo`, `birthNameList`, `maidenNameList`, `nickNameList`, `otherIdentityList`, `gender`, `birthdayY`, `birthdayM`, `birthdayD`, `birthCity`, `birthAccuracyLocation`, `deathdateM`, `deathdateD`, `deathdateY`, `deathCity`, `deathAccuracyLocation`, `cemeteryCity`, `cemeteryAccuracyLocation`, `biography`, `author`, `lastUpdate`, `createDate`) VALUES
(50, 'Pr&eacute;nom', 'JeuneFille', NULL, 'NomDuP&egrave;re', 'Marital', 'pseudo', 'erreurAdministrative', '2', 1789, 7, 14, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'geneager', '2023-04-13 11:35:01', '2023-04-11 19:04:14'),
(51, 'Pierre', 'Richard', NULL, NULL, NULL, NULL, NULL, '2', 1789, 7, 14, 100, 'H&ocirc;pital', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'geneager', '2023-09-03 17:59:14', '2023-05-29 19:44:01');
...
DROP TABLE IF EXISTS `ancestorarchive`;
...
CREATE TABLE `archive` (
  ...
  `yearEvent` int(4) NOT NULL COMMENT 'Type date ne convient pas (min an 1000)',
  `monthEvent` int(2) NOT NULL,
  `dayEvent` int(2) NOT NULL,
...
DROP TABLE IF EXISTS `jobname_ancestor`;
...
(65, 'Mariage de Wiktor et Bronislawa', 'Statuam longos posse et non sit est est quam gravius meruerim Glabrioni Acilio commendari.', 'a19af24a-8cda-47e3-8e9d-72877cea1a52_20230406_052243.webp', 100, 'Mairie', 1936, 7, NULL, 'Calinski', 'https://calinski.com', 42, '2023-04-07 14:49:24', '2023-04-06 15:22:43'),
(66, '2. Mariage de Wiktor et Bronislawa', '2. Statuam longos posse et non sit est est quam gravius meruerim Glabrioni Acilio commendari.', 'a19af24a-8cda-47e3-8e9d-72877cea1a52_20230406_052243.webp', 100, 'Mairie', 1936, 7, NULL, 'Calinski', 'https://calinski.com', 42, '2023-04-07 14:49:24', '2023-04-06 15:22:43');
...
DROP TABLE IF EXISTS `picturefolder`;
...
DROP TABLE IF EXISTS `relationancestor`;
...
DROP TABLE IF EXISTS `statedepartement`;
...
DROP TABLE IF EXISTS `transittype`;
