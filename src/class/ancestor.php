<?php
    ...
    class ancestor{
        ...
        public function getFullIdentity(bool $html = true):string{
            $ancestor = $this->get();
                $allNames = (format::normalize($ancestor["marriedNameList"])!="") ? " ".format::htmlToUpperFirst($ancestor["firstNameList"], $html)." ".format::htmlToUpper($ancestor["lastNameList"], $html)." (".format::htmlToUpper($ancestor["marriedNameList"], $html).")" : " ".format::htmlToUpperFirst($ancestor["firstNameList"], $html)." ".format::htmlToUpper($ancestor["lastNameList"], $html);
