<?php
    ...
    if($ancestorCount > 0 && $page <= $pageCount){
        $ancestorList = \model\ancestor::getList(array("id", "firstNameList", "lastName", "photo",  "maidenName", "gender", "birthdayY", "author"), $start, $resultPerPage, array($ancestorOrderBy, $sortBy), $filter);
